...
public class Signupthree extends JFrame  implements ActionListener{
    ...
    Signupthree(String formno){
        ...
        type.setFont(new Font("Raileway",Font.BOLD,22));
        ...
        number.setFont(new Font("Raileway",Font.BOLD,22));
        number.setBounds(330,300,300,30);
        add(number);

        JLabel carddetails=new JLabel("Your 16 digit card number");
        carddetails.setFont(new Font("Raileway",Font.BOLD,12));
        ...
        pnumber.setFont(new Font("Raileway",Font.BOLD,22));
        pnumber.setBounds(330,370,300,30);
        add(pnumber);

        JLabel pindetail=new JLabel("Your 4 digit Password");
        pindetail.setFont(new Font("Raileway",Font.BOLD,12));
        pindetail.setBounds(100,400,300,20);
        add(pindetail);

        JLabel services=new JLabel("Serices required:");
